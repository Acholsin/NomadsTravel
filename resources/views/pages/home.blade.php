                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                      <div class="testimonial-content">
                        ...
                        />
                        <h3 class="mb-4">Shroud</h3>
                        <p class="testimonial">
                          " WAW Sangat menarik pantek kali!! "
                        </p>
                      </div>
                      <hr />
                    ...
                    <div class="card card-testimonial text-center">
                      <div class="testimonial-content">
                        <img
                          ...
                          class="mb-4 rounded-circle"
                        />
                        <h3 class="mb-4">Aceu</h3>
                        <p class="testimonial">"Wah Banyak Tukang Somay!"</p>
                      </div>
                      <hr />
                      <p class="trip-to mt-2">Trip to Monas, Jakarta</p>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                      <div class="testimonial-content">
                        <img
                          ...
                          class="mb-4 rounded-circle"
                        />
                        <h3 class="mb-4">Gaben</h3>
                        <p class="testimonial">" WAW Mantab kali!! "</p>
                      </div>
                      <hr />
                      <p class="trip-to mt-2">Trip to Mekarsari, Cibubur</p>
                    </div>
                  </div>
                </div>
                <div class="row">
